...
namespace BulkyWeb.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ShoppingCartVM = new()
            {
                ShoppingCartLists = _unitOfWork.ShoppingCart.GetAll(u => u.ApplicationUserId == userId,
		...
		public IActionResult SummaryPOST()
		{
            ...
            ShoppingCartVM.ShoppingCartLists = _unitOfWork.ShoppingCart.GetAll(u => u.ApplicationUserId == userId, includeProperties: "Product");
        ...
        public IActionResult Remove(int cardId)
        {
            var cartFromDb = _unitOfWork.ShoppingCart.Get(u => u.Id == cardId);
            _unitOfWork.ShoppingCart.Remove(cartFromDb);
            TempData["success"] = $"{cartFromDb.Product} removed from the chart";
            _unitOfWork.Save();
            return RedirectToAction(nameof(Index));
        }
